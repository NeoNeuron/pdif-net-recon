...
int main(int argc,char **argv) {
  ...
  config.add_options()
    ...
    ("full_mode",   po::value<int>()->default_value(0), "Connectivity init mode: 0=random Erdos-Renyi (P_c/random_S), 1=full CLI entry via --conn_matrix, 2=load weighted matrix from --conn_matrix_file. Also toggles entry-by-entry --f (vs. fE/fI) for modes 1 and 2.")
