...
int main(int argc,char **argv)
{
	...
	generic.add_options()
		...
		("config,c", po::value<string>()->default_value("./Rcon/NetModel_parameters.ini"), "config filename.")
		;
	...
	config.add_options()
		...
		("S",           po::value<string>()->default_value("0.05 0.05 0.05 0.05"), "Synaptic coupling strength")
		("I_CONST",     po::value<double>()->default_value(0), "Constant external drive.")
		("full_mode",   po::value<int>()->default_value(0), "Assign connectivity matrix entry by entry.")
