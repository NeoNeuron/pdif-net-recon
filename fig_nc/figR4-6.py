...
axs = fig.subplots(6,8, gridspec_kw={
    'left': 0.04, 'right': 0.98, 'top': 0.92, 'bottom': 0.08,
    'hspace': 0.5, 'wspace': 0.4,
    })
ylims = [
    (0.2, 1.0), (0.1, 1.0), (0.2, 1.0), (0.0, 0.9), (0.2, 1.0), (0.45, 1.0),]
for axi, ylim, metric_key in zip(axs, ylims, ['accuracy', 'precision', 'recall', 'false discovery rate', 'F1 score', 'PR-AUC']):
    for net_key, ax in zip(net_keys, axi):
        ax = sns.lineplot(
            ...
            err_kws={'capsize': 3, 'lw':2, 'capthick':3}, legend=True if net_key=='HHEE' and metric_key=='accuracy' else False, clip_on=False)
