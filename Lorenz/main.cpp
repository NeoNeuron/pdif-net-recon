...
int main(int argc,char **argv)
{
    ...
    generic.add_options()
        ...
        ("config,c", po::value<string>()->default_value("./Lorenz/NetModel_parameters.ini"), "config filename.")
        ;
    ...
    config.add_options()
        ...
        ("T_Max",       po::value<double>()->default_value(1e6), "Simulation time period, unit ms.")
        ...
        ("Nu",          po::value<double>()->default_value(0.0), "Poisson input rate, unit kHz.")
        ...
        ("fE",          po::value<double>()->default_value(0.0), "Homogeneous FFWD Poisson strength for E neuron, if full_mode off.")
        ("fI",          po::value<double>()->default_value(0.0), "Homogeneous FFWD Poisson strength for I neuron, if full_mode off.")
        ...
        ("record_vlim", po::value<string>()->default_value("0 1e8"), "time range to record node traces.")
