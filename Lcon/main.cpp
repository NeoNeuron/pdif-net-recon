...
int main(int argc,char **argv)
{
	...
	generic.add_options()
		...
		("config,c", po::value<string>()->default_value("./Lcon/NetModel_parameters.ini"), "config filename.")
		;
	...
	config.add_options()
		...
		("P_c",         po::value<double>()->default_value(0.05), "Erdos-Renyi connecting probability.")
